    ...
    def _parse_data(self, raw_data):
        ...
        def check_reserved_domain(extension_name, whois_data):
            ...
            if extension_name in ['ac', 'bm', 'bz', 'sh', 'mu', 'mn'] and whois_data.find('This name is reserved by the Registry') > -1:
                ...
                result = True
            elif extension_name in ['bj', 'cm', 'cx', 'cv', 'rw', 'ss', 'ng', 'nf', 'gy', 'hn',
                                    'ke', 'ki', 'ms', 'ma', 'ly', 'kn', 'sb', 'tl', 'mg', 'so', 'gn', 'as'] and \
                ...
                result = True
            elif extension_name in ['bi', 'ps'] and whois_data.find('This string is on a restricted list, if registered, it will require approval') > -1:
                result = True
                ...
                result = True
            elif extension_name in ['my', 'ky', 'kw', 'iq','pw'] and whois_data.find('This name is not available for registration') > -1:
                result = True
                ...
                result = True
            elif extension_name == 'hk' and whois_data.find('This domain is currently not available for registration') > -1:
                result = True
            elif extension_name in ['ir', 'uz'] and whois_data.find('is not available for registration') > -1:
                result = True
            elif extension_name == 'pk' and whois_data.find('This domain cannot be registered') > -1:
                result = True
                ...
                result = True
            elif extension_name == 'ye' and whois_data.find('Domain name is reserved or restricted') > -1:
                result = True
