...
class TestI(unittest.TestCase):
    def test_ID(self):
        ...
        self.assertEqual(data['parse']['creation_date'], '2014-04-17T10:39:27Z')
    ...
    def test_IN(self):
        ...
        self.assertEqual(data['parse']['creation_date'], '2005-02-14T20:35:14.765Z')
        self.assertGreater(len(data['parse']['updated_date']), 0)
        self.assertGreater(len(data['parse']['expiry_date']), 0)
    ...
    def test_reserved_domain_ir(self):
        ...
        if not data['status']:
            print('Please check .ir whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_it(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "ai.it"},
        ...
        if not data['status']:
            print('Please check .it whois server - Reserved Domains!')
            return
