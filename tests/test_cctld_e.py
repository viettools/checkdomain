...
class TestE(unittest.TestCase):
    ...
    def test_reserved_domain_eu(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "ai.eu"},
        ...
        if not data['status']:
            print('Please check .eu whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_et(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "data.et"},
        ...
        if not data['status']:
            print('Please check .et whois server - Reserved Domains!')
            return
