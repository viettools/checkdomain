...
class TestS(unittest.TestCase):
    ...
    def test_reserved_domain_sb(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "fuck.sb"},
        ...
        if not data['status']:
            print('Please check .sb whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_sg(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "fuck.sg"},
        ...
        if not data['status']:
            print('Please check .sg whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_sh(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "rdap.sh"},
        ...
        if not data['status']:
            print('Please check .sh whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_sl(self):
        ...
        if not data['status']:
            print('Please check .sl whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_sm(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "data.sm"},
        ...
        if not data['status']:
            print('Please check .sm whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_so(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "ai.so"},
        ...
        if not data['status']:
            print('Please check .so whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_ss(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "whois.ss"},
        )
        data = json.loads(response.content)
        
        if not data['status']:
            print('Please check .ss whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_su(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "iana.su"},
        ...
        if not data['status']:
            print('Please check .su whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_sx(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "iana.sx"},
        ...
        if not data['status']:
            print('Please check .sx whois server - Reserved Domains!')
            return
