...
class TestH(unittest.TestCase):
    ...
    def test_reserved_domain_hk(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "xxx.hk"},
        ...
        if not data['status']:
            print('Please check .hk whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_hn(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "iana.hn"},
        ...
        if not data['status']:
            print('Please check .hn whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_hu(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "email.hu"},
        )
        data = json.loads(response.content)
        
        if not data['status']:
            print('Please check .hu whois server - Reserved Domains!')
            return
