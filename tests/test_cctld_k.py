...
class TestK(unittest.TestCase):
    ...
    def test_KW(self):
        ...
        self.assertEqual(data['parse']['creation_date'], '2007-03-17T00:00:00.000Z')
        self.assertGreater(len(data['parse']['updated_date']), 0)
        self.assertGreater(len(data['parse']['expiry_date']), 0)
    ...
    def test_reserved_domain_ke(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "iana.ke"},
        ...
        if not data['status']:
            print('Please check .ke whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_ki(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "fuck.ki"},
        ...
        if not data['status']:
            print('Please check .ki whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_kn(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "fuck.kn"},
        ...
        if not data['status']:
            print('Please check .kn whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_kr(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "xxx.kr"},
        ...
        if not data['status']:
            print('Please check .kr whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_kr_2(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "ai.kr"},
    ...
    def test_reserved_domain_kw(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "xxx.kw"},
        ...
        if not data['status']:
            print('Please check .kw whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_ky(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "xxx.ky"},
        ...
        if not data['status']:
            print('Please check .ky whois server - Reserved Domains!')
            return
