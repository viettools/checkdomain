...
class TestC(unittest.TestCase):
    ...
    def test_CI(self):
        ...
        self.assertEqual(data['parse']['creation_date'], '2013-02-14T00:00:00Z')
        self.assertGreater(len(data['parse']['updated_date']), 0)
        self.assertGreater(len(data['parse']['expiry_date']), 0)
    ...
    def test_CM(self):
        ...
        self.assertEqual(data['parse']['registrar_url'], 'http://www.netcom.cm')
        self.assertGreater(len(data['parse']['domain_status']), 0)
        self.assertGreater(len(data['parse']['nameservers']), 0)
        
        self.assertEqual(data['parse']['creation_date'], '2009-10-07T09:02:24Z')
        self.assertGreater(len(data['parse']['updated_date']), 0)
        self.assertGreater(len(data['parse']['expiry_date']), 0)
    ...
    def test_CO(self):
        ...
        self.assertEqual(data['parse']['creation_date'], '2010-02-25T01:04:59.0Z')
        self.assertGreater(len(data['parse']['updated_date']), 0)
        self.assertGreater(len(data['parse']['expiry_date']), 0)
    ...
    def test_reserved_domain_ca(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "fuck.ca"},
        ...
        if not data['status']:
            print('Please check .ca whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_cm(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "email.cm"},
        )
        data = json.loads(response.content)
        
        if not data['status']:
            print('Please check .cm whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_cn(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "fuck.cn"},
        ...
        if not data['status']:
            print('Please check .cn whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_cx(self):
        ...
        if not data['status']:
            print('Please check .cx whois server - Reserved Domains!')
            return
