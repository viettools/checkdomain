...
class TestT(unittest.TestCase):
    def test_TC(self):
        ...
        self.assertEqual(data['parse']['creation_date'], '1998-08-26T04:00:00.0Z')
    ...
    def test_TD(self):
        ...
        self.assertEqual(data['parse']['creation_date'], '2019-09-05T00:00:00Z')
    ...
    def test_reserved_domain_tc(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "domain.tc"},
        )
        data = json.loads(response.content)
        
        if not data['status']:
            print('Please check .tc whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_tm(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "fuck.tm"},
        ...
        if not data['status']:
            print('Please check .tm whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_tv(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "iana.tv"},
        ...
        if not data['status']:
            print('Please check .tv whois server - Reserved Domains!')
            return
    ...
    def test_reserved_domain_tw_2(self):
        response = client.post(
            '/api/v1/whois',
            headers={'X-Requested-With': 'XMLHttpRequest'},
            json={"domain": "ai.tw"},
