...
class TestA(unittest.TestCase):
    def test_AC(self):
        ...
        self.assertGreater(len(data['parse']['domain_status'] or False), 0, 'google.ac: Domain status must be a value!')
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.ac: NS must be a value!')
    ...
    def test_AE(self):
        ...
        self.assertGreater(len(data['parse']['domain_status'] or False), 0, 'google.ae: Domain status must be a value!')
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.ae: NS must be a value!')
    ...
    def test_AF(self):
        ...
        self.assertGreater(len(data['parse']['domain_status'] or False), 0, 'google.af: Domain status must be a value!')
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.af: NS must be a value!')
    ...
    def test_AG(self):
        ...
        self.assertGreater(len(data['parse']['domain_status'] or False), 0, 'google.ag: Domain status must be a value!')
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.ag: NS must be a value!')
    ...
    def test_AI(self):
        ...
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.ai: NS must be a value!')
    ...
    def test_AM(self):
        ...
        self.assertGreater(len(data['parse']['domain_status'] or False), 0, 'google.am: Domain status must be a value!')
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.am: NS must be a value!')
    ...
    def test_AR(self):
        ...
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.ar: NS must be a value!')
    ...
    def test_AS(self):
        ...
        self.assertGreater(len(data['parse']['domain_status'] or False), 0, 'google.as: Domain status must be a value!')
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.as: NS must be a value!')
    ...
    def test_AT(self):
        ...
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.at: NS must be a value!')
    ...
    def test_AU(self):
        ...
        self.assertGreater(len(data['parse']['domain_status'] or False), 0, 'google.au: Domain status must be a value!')
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.au: NS must be a value!')
    ...
    def test_AW(self):
        ...
        self.assertGreater(len(data['parse']['domain_status'] or False), 0, 'google.aw: Domain status must be a value!')
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'google.aw: NS must be a value!')
    ...
    def test_AX(self):
        ...
        self.assertGreater(len(data['parse']['domain_status'] or False), 0, 'whois.ax: Domain status must be a value!')
        self.assertGreater(len(data['parse']['nameservers'] or False), 0, 'whois.ax: NS must be a value!')
