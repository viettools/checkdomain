...
class WhOISccTLD:
    ...
    def get_whois_server(self, extension):
        dict_extension = {
            ...
            'gs': '185.17.239.201', #'whois.nic.gs',
            # 'gt': 'https://www.gt/sitio/index.php?lang=en',
            # 'gu': 'https://give.uog.edu/gu-domain-application-form/',
            # 'gw': 'https://nic.gw/en/whois/',
            'gy': '185.17.239.201', #'whois.registry.gy',
            'hk': 'whois.hkirc.hk',
            # 'hm': 'whois.registry.hm',
            'hn': '185.17.239.201', #'whois.nic.hn',
            'hr': 'whois.dns.hr',
            'ht': '185.17.239.201', #'whois.nic.ht',
            'hu': 'whois.nic.hu',
            'id': 'whois.id',
            'ie': 'whois.weare.ie',
            ...
            'ki': '185.17.239.201', #'whois.coccaregistry.org',
            ...
            'nf': '185.17.239.201', #'whois.nic.nf',
            'ng': 'whois.nic.net.ng',
            # 'ni': 'http://www.nic.ni',
            ...
            'sa': 'whois.nic.net.sa',
            'sb': '185.17.239.201', #'whois.nic.net.sb',
            'sc': 'whois.donuts.co',
            'sd': 'whois.sdnic.sd',
            'se': 'whois.iis.se',
            'sg': 'whois.sgnic.sg',
            ...
            'tk': 'whois.dot.tk',
            'tl': '185.17.239.201', #'whois.nic.tl',
            'tm': 'whois.nic.tm',
            'tn': 'whois.ati.tn',
            'to': 'whois.tonic.to',
